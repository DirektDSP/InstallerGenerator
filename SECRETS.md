...
| `CHASM_CONFIG_B64` | If Chasm licensed | chasm | base64 of Chasm's `moonbase_api_config.json`. |
...
gh secret set CHASM_CONFIG_B64             --repo DirektDSP/InstallerGenerator < chasm_moonbase_api_config.json.b64
